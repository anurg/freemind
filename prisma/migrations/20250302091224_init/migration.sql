...
CREATE TABLE "ProgressHistory" (
    "id" TEXT NOT NULL,
    "taskId" TEXT NOT NULL,
    "previousPercentage" INTEGER NOT NULL,
...
-- AddForeignKey
ALTER TABLE "ProgressHistory" ADD CONSTRAINT "ProgressHistory_taskId_fkey" FOREIGN KEY ("taskId") REFERENCES "Task"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
